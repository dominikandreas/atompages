...
{{metadata.impressum.name}}<br />
{{metadata.impressum.street}}<br />
{{metadata.impressum.zip}} {{metadata.impressum.city}}


<h2>Kontakt:</h2>

{% if metadata.impressum.telephone -%}
| Telefon:  | {{metadata.impressum.telephone}} |
{% endif %}
| E-Mail:   | {{metadata.impressum.email}}     |
